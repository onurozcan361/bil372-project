...
interface TeacherAvailableTimesProps {
  teacherAvailableTimes: TeacherAvailableTime[];
}
const TeacherAvailableTimesTabTable = (props: TeacherAvailableTimesProps) => {
  ...
  useEffect(() => {
    ...
    props.teacherAvailableTimes.forEach((time) => {
...
export default TeacherAvailableTimesTabTable;
